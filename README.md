...
# API de Gestão de Controle de Estoque

Este projeto é o scaffolding inicial de uma API para gestão de controle de estoque. Ele fornece a estrutura básica para o desenvolvimento de uma aplicação backend, utilizando Node.js, Express e Swagger para documentação.
...
1. Clone o repositório:
   ...
   git clone https://github.com/RamonCimol/estoque.git
...
- **Nome**: [Ramon]
- **E-mail**: [ramon-1196371@estudante.rs.gov.br]
- **GitHub**: [RamonCimol](https://github.com/RamonCimol)
